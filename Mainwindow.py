...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lable_batteryStatus.setText("100%")
        self.lable_batteryStatus.setGeometry(QtCore.QRect(160, 16, 24, 32))
        ...
        self.icon_battery.setGeometry(QtCore.QRect(140, 16, 24, 48))
        self.icon_battery.setObjectName("icon_battery")

        self.lable_carrier = QtWidgets.QLabel(self.centralwidget)
        self.lable_carrier.setGeometry(QtCore.QRect(0, 0, 44, 48))
        ...
        self.lable_carrier.setText("Сеть")
